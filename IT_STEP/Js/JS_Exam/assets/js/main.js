let cans = document.getElementsByClassName("err") 

 let auto = window.onload = function (e){
  fetch(
    "https://api.openweathermap.org/data/2.5/weather?q=Tashkent&appid=81e4c013d025c8ecaaafcae614d545e0"
  )
